...
public class NetworkFragment extends Fragment {
    ...
    TextView network_type, operator_name;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        network_type = Objects.requireNonNull(getView()).findViewById(R.id.network_type);
        network_type.setText(getNetworkType());
        operator_name = getView().findViewById(R.id.operator_name);
        operator_name.setText(getOperatorName());
    }
